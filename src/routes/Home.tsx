    ...
    return (
        <main className="flex-grow bg-slate-50">
            <div className="max-w-7xl p-8 mx-auto">
                ...
                <section className="my-8">
                    <header className="text-center mb-8">
                        <h2 className="text-4xl font-light">Start publishing <strong className="font-bold">in
                            seconds</strong></h2>
                ...
                <section className="my-8">
                    <p className="text-xl text-center">Got questions? <Link className="underline" to="/faqs">See the
                        FAQs</Link>.
                    </p>
                </section>
            </div>
